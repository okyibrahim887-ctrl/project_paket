...
<div class="header-actions">
    <form method="GET" class="filter-form" action="{{ route('admin.selesai') }}">
        ...
        <a href="{{ route('admin.selesai') }}"><button type="button" style="background:#e74c3c;">Reset</button></a>
    </form>

    <div class="table-buttons">
    <button onclick="window.print()" class="btn-cetak">🖨 Cetak</button>
    <a href="{{ route('admin.export', 'selesai') }}" class="btn-excel">📊 Export Excel</a>
    </div>
</div>
