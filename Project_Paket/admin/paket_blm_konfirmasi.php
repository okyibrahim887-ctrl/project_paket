...
<title>Paket Belum Diambil</title>
...
Data Pembukuan Paket Yang Belum Dikonfirmasi
</div>
...
", paket Anda belum diambil dari Pos Satpam lobby utama.\n".
"Status: ".$codText."\n".
...
<span style="background:#f39c12;color:white;padding:6px 12px;border-radius:20px;">
Belum Diambil
</span>
...
<a href="konfirmasi2.php?id=<?= $row['id']; ?>&status=1">
