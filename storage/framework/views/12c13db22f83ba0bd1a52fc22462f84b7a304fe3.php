...
<div class="table-title">Data Pembukuan Paket Mingguan</div>
<div class="table-buttons">
<button onclick="window.print()" class="btn-cetak">🖨 Cetak</button>
<a href="<?php echo e(route('admin.export', 'minggu')); ?>" class="btn-excel">📊 Export Excel Mingguan</a>
</div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\laravel_paket\resources\views/admin/paket_mingguan.blade.php ENDPATH**/ ?>