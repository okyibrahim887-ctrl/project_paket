...
<div class="table-title">Data Pembukuan Paket Belum Terkonfirmasi</div>

<div class="header-actions">
    <form method="GET" class="filter-form" action="<?php echo e(route('admin.belum_konfirmasi')); ?>">
        ...
        <a href="<?php echo e(route('admin.belum_konfirmasi')); ?>"><button type="button" style="background:#e74c3c;">Reset</button></a>
    </form>

    <div class="table-buttons">
    <button onclick="window.print()" class="btn-cetak">🖨 Cetak</button>
    <a href="<?php echo e(route('admin.export', 'belum')); ?>" class="btn-excel">📊 Export Excel</a>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\laravel_paket\resources\views/admin/paket_blm_konfirmasi.blade.php ENDPATH**/ ?>